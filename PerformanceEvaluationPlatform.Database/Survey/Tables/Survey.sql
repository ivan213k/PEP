...
(
	...
	CONSTRAINT [FK_Survey_AssigneeId] FOREIGN KEY ([AssigneeId]) REFERENCES [dbo].[User]([Id]) ON DELETE CASCADE,
	CONSTRAINT [FK_Survey_SupervisorId] FOREIGN KEY ([SupervisorId]) REFERENCES [dbo].[User]([Id]) ON DELETE CASCADE,
