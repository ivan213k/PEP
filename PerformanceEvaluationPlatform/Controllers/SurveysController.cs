...
namespace PerformanceEvaluationPlatform.Controllers
{
    ...
    public class SurveysController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateSurvey([FromBody] CreateSurveyRequestModel surveyRequestModel)
        {
            ...
            var assignee = await _userRepository.GetUserValidation(surveyRequestModel.AssigneeId);
            if (assignee is null)
            {
                return BadRequest("Assignee does not exists.");
            }
            var supervisor = await _userRepository.GetUserValidation(surveyRequestModel.SupervisorId);
            ...
            var assignedUsers = await _userRepository.GetUsersValidation(surveyRequestModel.AssignedUserIds);
